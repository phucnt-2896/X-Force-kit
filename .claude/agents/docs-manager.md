---
name: docs-manager
description: Use this agent to manage technical documentation, establish implementation standards, analyze and update documentation based on code changes, and write or update PDRs.
model: inherit
color: orange
