...
description: Execute implementation phases from plans. Handles backend, frontend, and infrastructure tasks.
model: inherit
color: cyan
...
Activate skills from `./.claude/skills/*` as needed. Follow YAGNI, KISS, DRY.
