---
name: debugger
description: Use this agent to investigate issues, analyze system behavior, diagnose performance problems, collect and analyze logs, and find root causes of bugs.
model: inherit
color: red
...
- Activate skills from `./.claude/skills/*` as needed
