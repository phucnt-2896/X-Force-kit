---
name: researcher
description: Use this agent to conduct comprehensive research on software development topics, investigate new technologies, find documentation, and explore best practices.
model: inherit
color: green
...
## Your Skills
Activate relevant skills from `./.claude/skills/*` as needed.
