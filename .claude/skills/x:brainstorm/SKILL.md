...
2. Existing modules/files relevant to the user's topic (use `x:scout` or Glob/Grep)
...
Extract exact requirements via `AskUserQuestion`. Must get concrete answers for:
