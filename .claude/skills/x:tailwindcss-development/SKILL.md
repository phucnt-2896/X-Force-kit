---
name: x:tailwindcss-development
description: "Always invoke when the user's message includes 'tailwind' in any form. Also invoke for building responsive grid layouts, page structures, styling UI components, adding dark mode variants, fixing spacing or typography, and Tailwind v3/v4 work."
---
...
Use `WebSearch` for detailed Tailwind CSS v3 patterns and documentation.
