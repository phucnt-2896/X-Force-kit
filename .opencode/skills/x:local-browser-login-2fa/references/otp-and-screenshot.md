...
```bash
./.claude/skills/x:local-browser-login-2fa/scripts/get-latest-otp.sh           # any portal
./.claude/skills/x:local-browser-login-2fa/scripts/get-latest-otp.sh Candidate # one portal
```
